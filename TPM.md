...
For why we need TPM, please read [[consensus#Proof of Trusted Computing]] for the reasons.

[[enclave]] is protected by the TPM, and the [[mini-runtime]] is running inside the [[enclave]].